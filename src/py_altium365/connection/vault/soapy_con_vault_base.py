...
class AluItemRevision(AluShareableObject, tag="item", nsmap={"temp": "http://tempuri.org/"}, ns="temp"):
    ...
    async def get_possible_life_cycle_state_transitions(self, altium_workspace: "AltiumApiWorkspace") -> "List[AluLifeCycleStateTransition]":
        """
        ...
        """
        return await altium_workspace.get_possible_life_cycle_state_transitions(self)

    async def change_life_cycle_state(self, altium_workspace: "AltiumApiWorkspace", transition: "AluLifeCycleStateTransition") -> bool:
        """
        ...
        """
        return await altium_workspace.change_life_cycle_state([self], [transition])

    async def get_life_cycle_state_changes(self, altium_workspace: "AltiumApiWorkspace") -> "List[AluLifeCycleStateChange]":
        """
...
class AluItem(AluShareableObject, tag="item", nsmap={"temp": "http://tempuri.org/"}, ns="temp"):
    ...
    async def get_folder(self, altium_workspace: "AltiumApiWorkspace") -> Optional[AluFolder]:
        """
        ...
        """
        if self.folder_guid:
            return await altium_workspace.get_folder_from_guid(self.folder_guid)
        return None
...
class AluFolder(AluShareableObject, tag="item", nsmap={"temp": "http://tempuri.org/"}, ns="temp"):
    ...
    async def get_parent_folder(self, altium_workspace: "AltiumApiWorkspace") -> Optional[AluFolder]:
        """
        ...
        if self.parent_folder_guid:
            return await altium_workspace.get_folder_from_guid(self.parent_folder_guid)
        return None

    async def get_child_folders(self, altium_workspace: "AltiumApiWorkspace") -> List[AluFolder]:
        """
        Get all child folders of this folder.
        :param altium_workspace: The Altium API workspace object.
        :return: A list of AluFolder objects representing the child folders.
        """
        return await altium_workspace.get_folders_in_folder(self)

    async def get_items(self, altium_workspace: "AltiumApiWorkspace") -> List[AluItem]:
        """
        Get all items in this folder.
        :param altium_workspace: The Altium API workspace object.
        :return: A list of AluItem objects in this folder.
        """
        return await altium_workspace.get_items_in_folder(self)
